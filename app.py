...
if menu == '類別管理':
    ...
    with tab2:
        ...
        if not cmap:
            ...
            if not imap:
                ...
                sel_sub = st.selectbox('選擇細項', list(sid_map.keys()), key='img_sel')
                sid = sid_map[sel_sub]
                # 圖片預覽與上傳
                ...
                with st.form('form_sub'):
                    ...
                    if st.form_submit_button('執行'):
                        ...
                        if del_s.isdigit() and confirm:
                            刪除('細項','細項編號',int(del_s))
    ...
    with tab4:
        ...
        if dfs.empty:
            ...
            sel_s = st.selectbox('選擇紀錄', list(desc_map_s.keys()), key='edit_s_sel')
            ...
            confirm_s= st.checkbox('確認刪除所選銷售？', key='batch_s_confirm')
